<template>
  <div class="result-card">
    ...
    <div class="card-header">
      ...
      <button v-if="canToggleCollapse && !expanded && items.length > initialVisible" class="expand-btn"
        @click="$emit('toggle')">
        展开
    ...
    <ul class="resource-list">
      <li v-for="(r, idx) in visibleItems" :key="idx" class="resource-item">
        <div class="resource-content">
          <a class="resource-link" :href="r.url" target="_blank" rel="noopener noreferrer nofollow"
            :title="r.note || r.url">
